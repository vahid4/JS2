...
// const getRating = (arr) => {
//   let nolanoviFilmovi = arr.filter((el) => {
//     return el.Director === "Christopher Nolan";
//   });
//   //console.log(nolanoviFilmovi)

//   const ocene = nolanoviFilmovi.map((el, i) => {
//     sveocene = Number(el.imdbRating);
...
//     return a+b
//   })
// const prosek=(suma/brojocena).toFixed(2)
//   return `Prosek ocena Nolanovih filmova je ${prosek}`;
// };
